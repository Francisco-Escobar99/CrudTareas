...
<div class="row">
    <div class="col-12">
        ...
        <div>
            <a href="{{route('tasks.index')}}" class="btn btn-primary mt-4">Volver</a>
        </div>
    </div>

    @if ($errors->any())
    <div class="alert alert-danger mt-2">
        <strong>Lo sentimos encontramos un error:</strong> informacion requerida..<br><br>
        <ul>
...
@endif
    ...
    <form action="{{ route('tasks.update', $task) }}" method="POST">
        @csrf <!--token medida de seguridad-->
        @method('PUT')
        <div class="row">
